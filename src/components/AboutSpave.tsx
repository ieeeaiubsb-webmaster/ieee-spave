...
export default function AboutSpave() {
  ...
  const images = [
    ...
    {
      src: "/images/content/_AR_9813.JPG",
      alt: "SPAVe Image 5",
      width: 1200,
      height: 800,
    },
  ...
  return (
    <div
      className={`container max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 mx-auto pb-4 px-4`}
    >
      <div className={`flex flex-col items-center justify-center px-2`}>
        ...
        <div className="mt-6 space-y-6 text-gray-500">
          <p className="text-lg text-justify mx-auto">
            ...
            Conferences and Ventures to address the constantly evolving world we
            live in today.The “x” in SPAx is a flexible component that can be
            adapted as needed. The IEEE AIUB Student Branch will organize the
            “IEEE Student Professional Awareness Venture” by replacing “x” with
            “Ve”. The objective of this successful venture is to educate and
            enrich the minds of future engineering leaders, helping them to
            sustain a successful career in their field. The venture includes
            day-long workshops, seminars, and technical talks by industry
            experts to support students’ professional growth. The motivation
            behind this flagship event is to educate students on securing a
